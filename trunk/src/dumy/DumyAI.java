        ...
        for (InfosBase base : infosBases)
        {
            ...
            if (base.constructionEnCours == typeBatiment.NONE)
            {
                ...
                else
                {
                    ...
                    if (Environement.get().isConstructionPossible(typeBatiment.BUCHERON, base))
                    {
                    ...
                    else if (Environement.get().isConstructionPossible(typeBatiment.MINE, base))
                    {
